      ...
      <div className="w-full max-w-md z-10">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 mt-2">Create an account to start your reading journey</p>
          </div>
          ...
          <p className="mt-8 text-center text-gray-600">
            ...
            <Link to="/sign-in" className="font-medium text-indigo-600 hover:text-indigo-800 transition-colors">
              Sign in
            </Link>
          </p>
        </motion.div>
